...
def main():
    dir_list = ['../data/SnomedCT_InternationalRF2_PRODUCTION_20180731T120000Z/Snapshot/Terminology/']
    for t in dir_list:
        print("dir", t)
    ...
    try:
        ...
        print('------------ checking get_internal_nodes----------------')
        print('internal node count: ', len(hier.get_internal_nodes()))

        print('------------ checking get_leaves----------------')
        print('leaves node count: ', len(hier.get_leaves()))
